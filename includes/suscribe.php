<div class="container">
    <div class="subs">
        <div class="subs__header">
            <h3>Suscríbete</h3>
            <h4>Conoce nuestras últimas publicaciones</h4>
            <p>Ingresa tu Email y recibe nuestras actualizaciones en tu buzón de correo</p>
        </div>
...
<div class="subsback">
    <div class="subsback__img">
        <img src="img/fondo-bajo.png" alt="Fondo Bajo Suscríbete">
    </div>
</div>